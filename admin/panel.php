...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
      <a href="salir.php" class="text-danger nav-link">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="dist/img/logo.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Pintureria<p>Iberoamericana</p></span>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="panel.php?modulo=admins" class="nav-link <?php echo($modulo=="admins" || $modulo=="crearadmin" || $modulo=="editaradmin")?" active ":" "; ?>">
...
$(function () {
  ...
  $(document).ready(function() {
    ...
    $('#tablaProductos').on( 'change', 'input.editor-active', function () {
        editor
    ...
    $(".borrar").click(function(e){
      e.preventDefault();
      var res=confirm("¿Está seguro de que quiere borrar este administrador?");
